...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.babylite.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.babylitetools.com");
        vSeeds.emplace_back("dnsseed.babylitepool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.babylitetools.com");
        vSeeds.emplace_back("seed-b.babylite.loshan.co.uk");

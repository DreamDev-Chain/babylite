...
const char * const BITCOIN_CONF_FILENAME = "babylite.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "babylite";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/babylite";
#else
    // Unix
    return pathRet / ".babylite";
#endif
#endif
}

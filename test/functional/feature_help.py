...
"""Verify that starting babylite with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start babylite with -h for help text")
        ...
        self.log.info("Start babylite with -version for version information")
        ...
        self.log.info("Start babylited with -fakearg to make sure it does not start")

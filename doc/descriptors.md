# Support for Output Descriptors in babylite Core

Since babylite Core v0.17, there is support for Output Descriptors. This is a
...
on babylite's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing babylite Core wallets, a convenience function `combo` is

babylite Core version 0.13.3 is now available from:

  <https://download.babylite.org/babylite-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/babylite-project/babylite/blob/0.13/src/chainparams.cpp#L214).
